...
export class PackagesService {
    ...
    getById(id: number) {
        return this.http.get(Helpers.apipath + 'getpackage/' + id).map((response: Response) => response.json());
    }
    ...
    create(userdata: any) {
        return this.http.post(Helpers.apipath + 'addpackage', userdata).map((response: Response) => response.json());
    }

    update(user: any) {
        return this.http.post(Helpers.apipath + 'updatepackage', user).map((response: Response) => response.json());
    }
